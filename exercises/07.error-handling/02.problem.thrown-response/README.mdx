...
```tsx filename=app/routes/sandwiches.$sandwichId.tsx lines=14,17,22
...
<callout-info>
	...
	more easily which works just the same way, but for the sake of clarity, these
	examples throw raw responses.
</callout-info>
