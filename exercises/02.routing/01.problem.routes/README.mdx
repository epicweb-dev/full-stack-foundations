...
So let's create the file for the `/users/kody/notes`
route. <InlineFile file="app/routes/users+/kody_+/notes.tsx">🐨 Click here to create <code>app/routes/users+/kody\_+/notes.tsx</code></InlineFile>
...
`notes.` to the
filename. <InlineFile file="app/routes/users+/kody_+/notes.some-note-id.tsx">🐨 Click here to create<code>app/routes/users+/kody\_+/notes.some-note-id.tsx</code></InlineFile>
...
"Notes" title and the "Some Note" text! 🎉
...
`some-note-id`
route. <InlineFile file="app/routes/users+/kody_+/notes.index.tsx">🐨 Click here to create <code>app/routes/users+/kody\_+/notes.index.tsx</code></InlineFile>
