...
<Routes>
	<Route file="root.tsx">
		...
		<Route
			...
			file="routes/_auth+/forgot-password_.verify.tsx"
		/>
		...
		<Route path="signup" file="routes/_auth+/signup/index.tsx" />
		<Route path="signup/verify" file="routes/_auth+/signup_.verify.tsx" />
		...
		/>
		<Route path="resources/theme" file="routes/resources+/theme/index.tsx" />
		<Route path="resources/verify" file="routes/resources+/verify.tsx" />
