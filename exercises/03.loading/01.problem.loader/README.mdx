...
The username is `kody` and I've added a link for Kody's profile on the home page
in the top right corner to make it easier for you to get to his profile which
can be found at <LinkToApp to="/users/kody" />.
